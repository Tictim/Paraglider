...
public final class EssenceDemandPreview implements DemandPreview{
	private final int quantity;
	private final List<ItemStack> preview;

	public EssenceDemandPreview(int quantity){
		this.quantity = quantity;
		this.preview = List.of(new ItemStack(Contents.get().essence()));
	}
	...
	@Override public int count(@NotNull Player player){
		return VesselContainer.get(player).essence();
	}
