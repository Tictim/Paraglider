...
public interface VesselContainer {
	...
	/**
	 * Register event listener for changes within this vessel container.
	 *
	...
	interface OnChangeListener {
		/**
		 * Callback for changes to the attached vessel containers' state. Does not respond to simulations, or invalid
		 * operations such as adding zero vessels.
		 *
		 * @param actionType Type of the value modified in this action
		 * @param change     Amount of changes made to the state; positive if the value was increased, negative if it
		 *                   decreased
