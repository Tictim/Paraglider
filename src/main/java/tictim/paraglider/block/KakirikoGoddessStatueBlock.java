...
public class KakirikoGoddessStatueBlock extends GoddessStatueBlock{
	public KakirikoGoddessStatueBlock(Properties properties){
		super(properties);
	}
	...
	@Override public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn){
		tooltip.add(new TranslationTextComponent("tooltip.paraglider.kakiriko_goddess_statue.0")
