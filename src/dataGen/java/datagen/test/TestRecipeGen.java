...
public class TestRecipeGen extends RecipeProvider {
	public TestRecipeGen(@NotNull PackOutput output, @NotNull CompletableFuture<HolderLookup.Provider> registries) {
	...
	@Override protected void buildRecipes(@NotNull RecipeOutput output) {
		new StatueBargainBuilder(ParagliderBargainTypes.GODDESS_STATUE)
				.demand(Ingredient.of(ItemTags.LEAVES), 64)
				.demand(Items.STICK, 64)
				.demand(Ingredient.of(ItemTags.LEAVES), 64)
				.offer(Items.OAK_BOAT, 1)
				.save(output, id("bargain_test/1"));
		new StatueBargainBuilder(ParagliderBargainTypes.GODDESS_STATUE)
				.demand(Items.GOLD_INGOT, 1)
				.offer(Items.DIRT, 1)
				.save(output, id("bargain_test/2"));
		new StatueBargainBuilder(ParagliderBargainTypes.GODDESS_STATUE)
				.demand(Items.IRON_INGOT, 2)
				.offer(Items.DIRT, 1)
				.save(output, id("bargain_test/3"));
		new StatueBargainBuilder(ParagliderBargainTypes.GODDESS_STATUE)
				.demand(Items.GOLD_INGOT, 3)
				.offer(Items.DIRT, 1)
				.save(output, id("bargain_test/4"));
		new StatueBargainBuilder(ParagliderBargainTypes.GODDESS_STATUE)
				.demand(Items.IRON_INGOT, 4)
				.offer(Items.DIRT, 1)
				.save(output, id("bargain_test/5"));
		new StatueBargainBuilder(ParagliderBargainTypes.GODDESS_STATUE)
				.demand(Items.GOLD_INGOT, 5)
				.offer(Items.DIRT, 1)
				.save(output, id("bargain_test/6"));
		new StatueBargainBuilder(ParagliderBargainTypes.GODDESS_STATUE)
				.demand(Items.IRON_INGOT, 6)
				.offer(Items.DIRT, 1)
				.save(output, id("bargain_test/7"));
		new StatueBargainBuilder(ParagliderBargainTypes.GODDESS_STATUE)
				.demand(Items.GOLD_INGOT, 7)
				.offer(Items.DIRT, 1)
				.save(output, id("bargain_test/8"));
		new StatueBargainBuilder(ParagliderBargainTypes.GODDESS_STATUE)
				.demand(Items.IRON_INGOT, 8)
				.offer(Items.DIRT, 1)
				.save(output, id("bargain_test/9"));
		new StatueBargainBuilder(ParagliderBargainTypes.GODDESS_STATUE)
				.demand(Items.GOLD_INGOT, 9)
				.offer(Items.DIRT, 1)
				.save(output, id("bargain_test/10"));
		new StatueBargainBuilder(ParagliderBargainTypes.GODDESS_STATUE)
				.demand(Items.IRON_INGOT, 10)
				.offer(Items.DIRT, 1)
				.save(output, id("bargain_test/11"));
		new StatueBargainBuilder(ParagliderBargainTypes.GODDESS_STATUE)
				...
				.save(output, id("bargain_test/things"));
		new StatueBargainBuilder(ParagliderBargainTypes.GODDESS_STATUE)
				.demand(Ingredient.of(Items.STICK), 1)
				.offerHeartContainer(2)
				.save(output, id("bargain_test/heart"));
		new StatueBargainBuilder(ParagliderBargainTypes.GODDESS_STATUE)
				.demand(Ingredient.of(Items.STICK), 1)
				.offerHeartContainer(100)
				.save(output, id("bargain_test/heart100"));
	}

	public DataProvider wrap() {
		return new WrappedProvider(this);
	}

	public static class WrappedProvider implements DataProvider {
		private final TestRecipeGen testRecipeGen;

		public WrappedProvider(TestRecipeGen testRecipeGen) {
			this.testRecipeGen = testRecipeGen;
		}

		@Override public @NotNull CompletableFuture<?> run(@NotNull CachedOutput output) {
			return testRecipeGen.run(output);
		}
